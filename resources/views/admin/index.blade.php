            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-4 type-1-center">
                    <article class="big white table" style="text-align: left;">
                        <h1 class="h1">make your life simplier</h1>
                        <p>Praesent iaculis ligula eu nulla porttitor, eget imperdiet odio pulvinar. Donec massa arcu fermentum ac urna.</p>
                        <a href="#" class="button" style="margin-bottom: 15px; margin-left: 0;"><span>take a tour of lorem ipsum!</span></a>
                    </article>
                </div>
            </div>
        </div>
    ...
    <div class="new-block color-background scroll-to-block" data-id="about">
        <div class="container">
            <div class="row page-tagline">
                <div class="col-md-12">
                    <h2 class="title wow fadeInUp" data-wow-delay="0.3s">about us</h2>
                    <img class="dividing-image wow flipInX" data-wow-delay="0.3s" src="img/content/Home-6/about-image.jpg" alt="" />
                    <div class="description typography-article wow fadeInUp" data-wow-delay="0.3s">
                        <div class="row">
                            <div class="col-sm-6">
                                <p>Praesent at vestibulum tortor. Praesent condimentum efficitur massa pharetra dolor sed. Tonsequat in erat ut, congue bibendum nulla. Suspendisse id pharetra lacus, et hendrerit mi. Praesent at vestibulum tortor. Praesent condimentum efficitur massa pharetra dolor sed. Tonsequat in erat ut, congue bibendum nulla. Suspendisse id pharetra lacus, et hendrerit mi. Praesent at vestibulum tortor. Praesent condimentum efficitur massa pharetra dolor sed.</p>
                            </div>
                            <div class="col-sm-6">
                                <p>Praesent at vestibulum tortor. Praesent condimentum efficitur massa pharetra dolor sed. Tonsequat in erat ut, congue bibendum nulla. Suspendisse id pharetra lacus, et hendrerit mi. Praesent at vestibulum tortor. Praesent condimentum efficitur massa pharetra dolor sed. Tonsequat in erat ut, congue bibendum nulla. Suspendisse id pharetra lacus, et hendrerit mi. Praesent at vestibulum tortor. Praesent condimentum efficitur massa pharetra dolor sed.</p>
                            </div>
                    ...
                    <div class="col-sm-4 col-sm-pull-4">
                        <div class="phone-icons-description right-align">
                            <div class="entry wow fadeInRight" data-wow-delay="0.3s">
                                <div class="icon"><img alt="" src="img/theme-1/icon10.png" /></div>
                                <div class="content">
                            ...
                            <div class="entry wow fadeInRight" data-wow-delay="0.5s">
                                <div class="icon"><img alt="" src="img/theme-1/icon11.png" /></div>
                                <div class="content">
                            ...
                            <div class="entry wow fadeInRight" data-wow-delay="0.7s">
                                <div class="icon"><img alt="" src="img/theme-1/icon12.png" /></div>
                                <div class="content">
                    ...
                    <div class="col-sm-4">
                        <div class="phone-icons-description">
                            <div class="entry wow fadeInLeft" data-wow-delay="0.3s">
                                <div class="icon"><img alt="" src="img/theme-1/icon13.png" /></div>
                                <div class="content">
