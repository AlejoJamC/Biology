									...
									<tbody>
                                        @foreach ($students as $student)
											<tr>
												...
												<td>{{ $student->email }}</td>
												<td>
                                                    <form action="/dashboard/teacher/course/student/{{ $course->id }}/delete" method="POST">
                                                        {{ csrf_field() }}
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <input class="hidden" type="text" name="student" value="{{ $student->key }}">
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/dashboard/teacher/course/student/{{ $course->id }}/create" method="POST">
