    ...
    <div class="new-block type-11 scroll-to-block" data-id="home">
        ...
        <div class="swiper-container horizontal-pagination" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="1">
            ...
            <div class="banner-tabs">
                <div class="container">
                    <div class="row">
                        <div class="entry active col-md-3 wow fadeInUp" data-wow-delay="0.3s"><span class="title">Try this</span> <span class="description">new horizons of communication</span></div>
                        <div class="entry col-md-3 wow fadeInUp" data-wow-delay="0.6s"><span class="title">remember this</span> <span class="description">a new look at mobile applications</span></div>
                        <div class="entry col-md-3 wow fadeInUp" data-wow-delay="0.9s"><span class="title">feel this</span> <span class="description">simplicity and convenience</span></div>
                        <div class="entry col-md-3 wow fadeInUp" data-wow-delay="1.2s"><span class="title">take this</span> <span class="description">is your indispensable assistant</span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container type-3-text">
            ...
            <div class="row">
                <div data-wow-delay="0.3s" class="col-md-4 col-sm-6 little-img-text-entry wow flipInY">
                    <img src="img/theme-1/icon10.png" alt="">
                    <article class="small">
                ...
                <div data-wow-delay="0.6s" class="col-md-4 col-sm-6 little-img-text-entry wow flipInY">
                    <img src="img/theme-1/icon11.png" alt="">
                    <article class="small">
                ...
                <div data-wow-delay="0.3s" class="col-md-4 col-sm-6 little-img-text-entry wow flipInY">
                    <img src="img/theme-1/icon13.png" alt="">
                    <article class="small">
                ...
                <div data-wow-delay="0.6s" class="col-md-4 col-sm-6 little-img-text-entry wow flipInY">
                    <img src="img/theme-1/icon14.png" alt="">
                    <article class="small">
                ...
                <div class="col-md-3">
                    <div class="tabs-limit-container">
                        <div class="tabs-switch active wow fadeInLeft" data-wow-delay="0.3s">
                            <img src="img/theme-1/icon18.png" alt="" /><span>global Weather</span>
                        </div>
                        <div class="tabs-switch wow fadeInLeft" data-wow-delay="0.3s">
                            <img src="img/theme-1/icon16.png" alt="" /><span>Online Shop</span>
                        </div>
                        <div class="tabs-switch wow fadeInLeft" data-wow-delay="0.3s">
                            <img src="img/theme-1/icon17.png" alt="" /><span>your Tracking</span>
                        </div>
                        <div class="tabs-switch wow fadeInLeft" data-wow-delay="0.3s">
                            <img src="img/theme-1/icon19.png" alt="" /><span>Food Order</span>
                        </div>
                        <div class="tabs-switch wow fadeInLeft" data-wow-delay="0.3s">
                            <img src="img/theme-1/icon20.png" alt="" /><span>Quick Chat</span>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
