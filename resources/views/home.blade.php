        ...
        <div class="container">
            <div class="row page-tagline">
                <div class="col-md-6 col-md-offset-3 wow flipInX" data-wow-delay="0.3s">
                    <h2 class="title">desarrollado</h2>
                    <div class="description">Se realiza implementacion y desarrollo de un Objeto Virtual de Aprendizaje (OVA) interactivo mediado por las TIC usando HTML 5, CSS3 y JavaScript, para mejorar el proceso de enseñanza y aprendizaje de la biología del grado quinto (5°).</div>
                </div>
            </div>
                    ...
                    <div class="contact-thumbs">
                        ...
                        <article class="normall">
                            <p>
                                Tel:
                                <br>
                                <a href="tel:3222704123">3222704123</a>
                            </p>
                        </article>
                    </div>
                    <div class="contact-thumbs">
